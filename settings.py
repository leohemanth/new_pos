# Django settings for new_pos project.
...
DATABASE_NAME = 'pos.db'             # Or path to database file if using sqlite3.
...
SECRET_KEY = 'f32@$$5ff=isjd_+zpefgjy&ap7$n2rz*14g)6)yz5in2!7krc'
