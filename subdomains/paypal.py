...
class PayPal:
    ...
    def __init__(self):
        ...
        'PWD' : '1225388785', # Edit this to your API password
        'SIGNATURE' : 'AtSmeOZ-bsDt3B1GVssgHp49.uU8ATt.YD423D-Z6HNy9yoID2f8egfV', # edit this to your API signature
        'VERSION' : '53.0',
        }
    ...
    def SetExpressCheckout(self, amount, return_url, cancel_url, **kwargs):
        ...
        if not 'Success' in response_dict['ACK']:
            raise PaypalException('There was a failure talking to Paypal. Request NVP: ')
